...
<body>
<form class="layui-form" action="admininfosave" method="post" style="width: 50%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="picurl" required  lay-verify="required" placeholder="请输入管理员头像 可以使用网络图片" autocomplete="off" class="layui-input">
        </div>
    </div>
